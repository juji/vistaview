...
See the [Getting Started](/getting-started/react) guides for framework-specific instructions.

## Next Steps

- Follow a [Getting Started guide](/getting-started/react) for your framework
