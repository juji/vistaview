...
function SolidHeroContentBox() {
  onMount(() => {
    vistaView({ elements: '#solid-image-grid a' });
  });
  return (
    <div className="hero-content-box">
      <div id="solid-image-grid" className="image-grid vista-view">
...
export default SolidHeroContentBox;

// Style parity with Astro HeroContentBox
if (typeof window !== 'undefined') {
  const styleId = 'solid-hero-content-box-style';
